...
import { RefreshCw, Activity, Moon, Zap, ShieldAlert } from 'lucide-react';
    ...
    <div className="bg-washi border border-sumi/10 shadow-sm p-6 md:p-8 relative transition-all duration-300">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b border-shibu pb-4 mb-6 gap-4">
        ...
        <button
          onClick={handleSync}
          disabled={isSyncing}
          className="self-start sm:self-center flex items-center gap-2 text-xs font-mono uppercase tracking-wider text-aizome border border-aizome/30 px-3 py-1.5 hover:bg-aizome hover:text-washi transition-all duration-300 disabled:opacity-50"
        >
